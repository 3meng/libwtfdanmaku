...
namespace WTFDanmaku {
    ...
    DanmakuRef DanmakuFactory::CreateDanmaku(DanmakuType type, time_t time, const std::wstring& comment, int fontSize, int fontColor, time_t timestamp, uint64_t danmakuId) {
